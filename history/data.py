        ...
        try:
            ...
            if len(data) >1:
                try:
                    ...
                    df_monthly=pd.concat([df_monthly, df_monthly_max],keys=['year','month'],ignore_index=True)
                    ...
                    df_monthly=pd.concat([df_monthly, df_monthly_low],keys=['year','month'],ignore_index=True)
