        ...
        try:
            ...
            if len(data) >1:
                try:
                    ...
                    df_monthly=(pd.concat([df_monthly, df_monthly_max],join="inner",ignore_index=True)).reset_index(drop=True)
                    ...
                    df_monthly=(pd.concat([df_monthly, df_monthly_low],join="inner",ignore_index=True)).reset_index(drop=True)
