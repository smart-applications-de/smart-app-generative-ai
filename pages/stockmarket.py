...
if germin_key  and serp_key:
    ...
    def getCrewAINews(topic,model="gemini/gemini-1.5-pro"):
        ...
        try:
            ...
            results=CrewStocknews( germin_key, serp_key,topic,yr,date,company, sector, summary,model)
            return results
    ...
    def getCrewAIAgentRecommendation(option,model="gemini/gemini-1.5-pro"):
        ...
        try:
            ...
            results=StockMarketCrew( germin_key,serp_key,option, history, financal_data,company, sector,summary,industry,website,company_stock_info,model).run()
            return results
        except Exception as error:
            return  error
    ...
    with (tab4):
        ...
        model1= container.slider(
                "Choose a Model",
                [":rainbow[gemini/gemini-1.5-pro]", "***gemini/gemini-1.5-flash-8b***", "gemini/gemini-1.5-flash",  "gemini/gemini-2.0-flash-exp","gemini/gemini-exp-1206","gemini/gemini-2.0-flash-thinking-exp-01-21"],
               key='model1'
        )
