...
if germin_key  and serp_key:
    ...
    def getCrewAINews(topic):
        ...
        try:
            ...
            results=CrewStocknews( germin_key, serp_key,topic,yr,date,company, sector, summary)
            return results
    ...
    def getCrewAIAgentRecommendation(option):
        ...
        try:
            ...
            results=StockMarketCrew( germin_key,serp_key,option, history, financal_data,company, sector,summary,industry,website,company_stock_info).run()
            return results
        except Exception as error:
            return  error
